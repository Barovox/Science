...
const allTabs = [
  {
    label: "Thông tin đề tài nghiệm thu",
...
const BTCMModal = ({
  ...
  const [tab, setTab] = useState(openTab || "phan-bien-chuyen-mon");
  ...
  const fetchData = async () => {
    try {
      const res = await axios.get(
        `${SERVER_API_URL}/HDNghiemThuDT_CBGVNV/Get-by-id?idDanhMuc=${idDanhMuc}`,
        {
          headers: {
