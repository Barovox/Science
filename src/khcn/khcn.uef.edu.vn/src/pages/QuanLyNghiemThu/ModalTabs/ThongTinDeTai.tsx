    ...
    <>
      <Paper shadow="xs" withBorder p="xl">
        ...
        <Grid>
          ...
          <Grid.Col span={{ base: 12, md: 6 }}>
            <Title order={5}>File bản thảo</Title>
            <Accordion
              variant="contained"
              radius="md"
              multiple
                ...
                <Table.Tr>
                  ...
                  <Table.Td>
                    {baiBaoData.danhSachHDNghiemThu
                      ? JSON.parse(baiBaoData.danhSachHDNghiemThu).length
                      : 0}
                  </Table.Td>
                </Table.Tr>
                <Table.Tr>
                  ...
                  <Table.Td>
                    {baiBaoData.danhSachHDNghiemThu
                      ? JSON.parse(baiBaoData.danhSachHDNghiemThu).filter(
          ...
          <Grid.Col span={{ base: 12, md: 6 }}>
            {isSent && (
              <Text mt="md" mb="md" fw="bold">
                ...
                {baiBaoData.status_nghiemThu == "Nghiệm thu ĐẠT" ||
                baiBaoData.status_nghiemThu == "Nghiệm thu KHÔNG ĐẠT"
            ...
            <Select
              label="Kết luận"
              data={["Nghiệm thu ĐẠT", "Nghiệm thu KHÔNG ĐẠT"]}
              value={selectStatus}
