...
const MoiHoiDong = ({
  ...
  return (
    <>
      <Title order={3}>Mời phản biện</Title>

      <Blockquote color="blue" my="md">
        <Text>
          Vui lòng nhập vào ô <strong>"Tìm kiếm"</strong> để mời phản biện.
        </Text>
        <Text>
          Trong trường hợp người phản biện chưa có trên hệ thống, Biên tập
